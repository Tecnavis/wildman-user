...
const ProductImageDescription = lazy(() =>
  import("../src/wrappers/product/ProductImageDescription")
);
        ...
        <ScrollToTop>
          ...
          >
            <Routes>
              ...
              />
              <Route
                path={process.env.PUBLIC_URL + "/productview/:id"}
                element={<ProductImageDescription/>}  
              />
              ...
              />
              <Route
                path={process.env.PUBLIC_URL + "/category/:categoryName"}
